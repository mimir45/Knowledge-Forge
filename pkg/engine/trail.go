...
// they stay deliberately absent here — pkg/engine/trail_entry_test.go pins this. B-022
// only widened what references/schema.yaml's engine_trail item_pattern *accepts* (all
