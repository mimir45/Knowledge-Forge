...
// Doc is one note as recall sees it: frontmatter, plus a lazy handle on the body.
type Doc struct {
...
// Thresholds is the decision tree.
...
// Channel is one weighted component of the score.
type Channel struct {
